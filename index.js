...
app.get('/api/v1/farmacia-manuelito/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://ladybird-regular-blatantly.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.put('/api/v1/manuel/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/manuel/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
//GAEL LIMAS
app.get('/api/v1/farmacia-limas/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://likely-blessed-tiger.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.get('/api/v1/limas/medicamentos', async (req, res) => {
    try {
        const response = await axios.get('https://likely-blessed-tiger.ngrok-free.app/api/medicamentosPED');
        res.json(response.data);
    } catch (error) {
        console.error('Error al obtener los datos:', error.message);
        res.status(500).json({ error: 'Error al obtener los datos de la API externa' });
...
app.put('/api/v1/limas/espera-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para cancelar el pedido
        const apiResponse = await axios.put(`https://likely-blessed-tiger.ngrok-free.app/api/pedidos/${pedidoId}`, {
            estado: 'cancelado',
            notas: `Cancelado: ${motivo}`
        });
...
app.put('/api/v1/limas/cancelar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
...
app.put('/api/v1/limas/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/limas/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/limas/pagado-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.post('/api/v1/limas/actualizar-stock-externo', async (req, res) => {
    const { productos } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para actualizar el stock
        const apiResponse = await axios.post('https://likely-blessed-tiger.ngrok-free.app/api/actualizar-stock', {
            productos: productos
        }, {
            headers: {
                'Content-Type': 'application/json'
...
app.get('/api/v1/farmacia-mauro/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://careful-coherent-chigger.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.put('/api/v1/mauro/espera-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para cancelar el pedido
        const apiResponse = await axios.put(`https://careful-coherent-chigger.ngrok-free.app/api/pedidos/${pedidoId}`, {
            estado: 'cancelado',
            notas: `Cancelado: ${motivo}`
        });
...
app.put('/api/v1/mauro/cancelar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
...
app.put('/api/v1/mauro/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/mauro/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/mauro/pagado-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.post('/api/v1/mauro/actualizar-stock-externo', async (req, res) => {
    const { productos } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para actualizar el stock
        const apiResponse = await axios.post('https://careful-coherent-chigger.ngrok-free.app/api/actualizar-stock', {
            productos: productos
        }, {
            headers: {
                'Content-Type': 'application/json'
...
// ANGEL
app.get('/api/v1/farmacia-angel/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://husky-hip-supposedly.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.get('/api/v1/angel/medicamentos', async (req, res) => {
    try {
        const response = await axios.get('https://husky-hip-supposedly.ngrok-free.app/api/pedidos/medicamentos-bodega');
        res.json(response.data);
    } catch (error) {
        console.error('Error al obtener los datos:', error.message);
        res.status(500).json({ error: 'Error al obtener los datos de la API externa' });
...
app.put('/api/v1/angel/espera-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para cancelar el pedido
        const apiResponse = await axios.put(`https://husky-hip-supposedly.ngrok-free.app/api/pedidos/${pedidoId}`, {
            estado: 'cancelado',
            notas: `Cancelado: ${motivo}`
        });
...
app.put('/api/v1/angel/cancelar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
...
app.put('/api/v1/angel/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/angel/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/angel/pagado-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.post('/api/v1/angel/actualizar-stock-externo', async (req, res) => {
    const { productos } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para actualizar el stock
        const apiResponse = await axios.post('https://husky-hip-supposedly.ngrok-free.app/api/pedidos/actualizar-stock', {
            productos: productos
        }, {
            headers: {
                'Content-Type': 'application/json'
...
//PEPE
app.get('/api/v1/farmacia-pepe/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://coral-novel-radically.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.get('/api/v1/pepe/medicamentos', async (req, res) => {
    try {
        const response = await axios.get('https://coral-novel-radically.ngrok-free.app/api/medicamentosPED');
        res.json(response.data);
    } catch (error) {
        console.error('Error al obtener los datos:', error.message);
        res.status(500).json({ error: 'Error al obtener los datos de la API externa' });
...
app.put('/api/v1/pepe/espera-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para cancelar el pedido
        const apiResponse = await axios.put(`https://coral-novel-radically.ngrok-free.app/api/pedidos/${pedidoId}`, {
            estado: 'cancelado',
            notas: `Cancelado: ${motivo}`
        });
...
app.put('/api/v1/pepe/cancelar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
...
app.put('/api/v1/pepe/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/pepe/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/pepe/pagado-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.post('/api/v1/pepe/actualizar-stock-externo', async (req, res) => {
    const { productos } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para actualizar el stock
        const apiResponse = await axios.post('https://coral-novel-radically.ngrok-free.app/api/actualizar-stock', {
            productos: productos
        }, {
            headers: {
                'Content-Type': 'application/json'
...
//DIEGO https://credible-certainly-dinosaur.ngrok-free.app
app.get('/api/v1/farmacia-diego/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://credible-certainly-dinosaur.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.get('/api/v1/diego/medicamentos', async (req, res) => {
    try {
        const response = await axios.get('https://credible-certainly-dinosaur.ngrok-free.app/api/medicamentosPED');
        res.json(response.data);
    } catch (error) {
        console.error('Error al obtener los datos:', error.message);
        res.status(500).json({ error: 'Error al obtener los datos de la API externa' });
...
app.put('/api/v1/diego/espera-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para cancelar el pedido
        const apiResponse = await axios.put(`https://credible-certainly-dinosaur.ngrok-free.app/api/pedidos/${pedidoId}`, {
            estado: 'cancelado',
            notas: `Cancelado: ${motivo}`
        });
...
app.put('/api/v1/diego/cancelar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
...
app.put('/api/v1/diego/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/diego/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/diego/pagado-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.post('/api/v1/diego/actualizar-stock-externo', async (req, res) => {
    const { productos } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para actualizar el stock
        const apiResponse = await axios.post('https://credible-certainly-dinosaur.ngrok-free.app/api/actualizar-stock', {
            productos: productos
        }, {
            headers: {
                'Content-Type': 'application/json'
...
//RAUL
app.get('/api/v1/farmacia-raul/pedidos', async (req, res) => {
    try {
        // Obtener datos de la API original
        const response = await axios.get('https://sailfish-organic-javelin.ngrok-free.app/api/pedidos', {
            // Aquí puedes añadir headers de autenticación si son necesarios
            headers: {
                // 'Authorization': `Bearer ${process.env.FARMACIA_CESAR_TOKEN}`
            }
...
app.get('/api/v1/raul/medicamentos', async (req, res) => {
    try {
        const response = await axios.get('https://sailfish-organic-javelin.ngrok-free.app/api/medicamentosPED');
        res.json(response.data);
    } catch (error) {
        console.error('Error al obtener los datos:', error.message);
        res.status(500).json({ error: 'Error al obtener los datos de la API externa' });
...
app.put('/api/v1/raul/espera-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para cancelar el pedido
        const apiResponse = await axios.put(`https://sailfish-organic-javelin.ngrok-free.app/api/pedidos/${pedidoId}`, {
            estado: 'cancelado',
            notas: `Cancelado: ${motivo}`
        });
...
app.put('/api/v1/raul/cancelar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { motivo } = req.body;
...
app.put('/api/v1/raul/confirmar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/raul/completar-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.put('/api/v1/raul/pagado-pedido-externo/:id', async (req, res) => {
    const pedidoId = req.params.id;
    const { observacion } = req.body;
...
app.post('/api/v1/raul/actualizar-stock-externo', async (req, res) => {
    const { productos } = req.body;
    ...
    try {
        // Hacer la petición a la API externa para actualizar el stock
        const apiResponse = await axios.post('https://sailfish-organic-javelin.ngrok-free.app/api/actualizar-stock', {
            productos: productos
        }, {
            headers: {
                'Content-Type': 'application/json'
